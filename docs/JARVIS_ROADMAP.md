...
- **0.9.49**: layout reproduce com fidelidade — referência + prompt travado (não inventa VS/cinematic)
...
WA: print + `reproduz esse layout só que com…` → **mesma estrutura**, só a troca pedida
