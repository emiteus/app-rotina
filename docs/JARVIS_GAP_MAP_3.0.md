...
**Baseline:** v0.9.49 (`R:\Projetos\Jarvis` → sync → app-rotina)  
...
22. ~~Layout reproduce fidelidade~~ **DONE 0.9.49** — gera imagem com referência + prompt travado (sem reinventar template).
