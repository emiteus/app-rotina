...
const despesas = [
  ...
  { titulo: 'TIM', valor: 43.0, dia: null, categoria: 'assinaturas' },
  { titulo: 'Discord', valor: 24.99, dia: null, categoria: 'assinaturas' },
  { titulo: 'Twitch', valor: 9.99, dia: null, categoria: 'assinaturas' },
  { titulo: 'Crunchyroll', valor: 19.9, dia: null, categoria: 'assinaturas' },
  { titulo: 'Netflix', valor: 20.9, dia: null, categoria: 'assinaturas' },
  { titulo: 'Spotify', valor: 23.9, dia: null, categoria: 'assinaturas' },
  ...
  { titulo: 'Cursor', valor: 120.0, dia: null, categoria: 'assinaturas' },
  { titulo: 'Google Drive', valor: 9.9, dia: null, categoria: 'assinaturas' },
  { titulo: 'Google Drive adicional', valor: 12.5, dia: null, categoria: 'assinaturas' },
...
const extrasPorMes = {
  '2026-08': [
    ...
    { titulo: 'Fatura cartão', valor: 88.48, dia: 17, categoria: 'outros' },
    { titulo: 'Fatura Inter', valor: 441.02, dia: 18, categoria: 'outros' }
  ],
  '2026-09': [
