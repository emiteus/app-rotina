...
const despesas = [
  ...
  { titulo: 'Internet', valor: 75.0, dia: 10, categoria: 'contas_fixas', aliases: ['Vivo Fibra', 'Vivo Internet', 'Claro Net', 'Oi Fibra'] },
  { titulo: 'Consórcio', valor: 410.04, dia: 10, categoria: 'contas_fixas', aliases: ['Consorcio'] },
...
const extrasPorMes = {
  ...
  '2026-09': [
    { titulo: 'Cartão da mãe', valor: 506.4, dia: 5, categoria: 'faturas' }
  ]
};
