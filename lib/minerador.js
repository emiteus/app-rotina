...
const feed = ({ janela = 6, limite = 10, pagina } = {}) => {
...
module.exports = { mineradorReady, feed, sources, addSource, addSources, removeSource, setStatus, status, getMineradorSnapshot, _setFetch };
