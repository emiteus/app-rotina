...
const COMMON_FLAGS = [
  ...
  {
    key: 'crons',
    label: 'Crons / jobs agendados',
    description: 'Pausa jobs agendados do host'
  },
  {
    key: 'proactive_wa',
    label: 'Proatividade WhatsApp',
    description: 'Pausa alertas proativos no WA'
  }
];
...
const PROJECT_FLAGS = {
  ...
  approtina: {
    keys: ['crons', 'proactive_wa'],
    adapter: 'approtina'
  },
  cutflix: {
    keys: ['crons']
    // sem adapter live ainda — store local
  },
  cinerush_editor: {
    keys: ['access_automation']
    // auto_post futuro; store local por enquanto
  }
};
