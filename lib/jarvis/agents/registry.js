...
- Write: dev_railway_redeploy (rebuild) ou dev_railway_restart (sem rebuild) — critical, pede SIM.
...
- NÃO emita patch de código nem deploy além de redeploy Railway.
