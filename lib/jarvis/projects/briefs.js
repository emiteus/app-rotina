...
const PROJECT_BRIEFS = {
  ...
  socialhub: {
    ...
    brief:
      'Next.js pra gestão/agendamento multi-plataforma (YouTube, Instagram, Facebook, TikTok) com analytics, categorias e fila BullMQ. Prisma+Postgres. Prod: teushub.online. Jarvis: socialhub_posts / agendar / publicar_agendados.',
    people: ['Mateus'],
  ...
  projeto_milhao: {
    ...
    brief:
      'Cron Node que scrapeia reels IG de páginas (Mateus: filmelabs, ney.filmes, mister.cine; Erik: isinhafilmes, maniadefilmesbr), soma views e manda relatório no grupo WhatsApp "Projeto Milhão" via Evolution. Meta ~30 posts/dia por pessoa. Docker com IG_FONTE=embed. Mundo de cortes/filmes, paralelo ao Attracione.',
    people: ['Mateus', 'Erik'],
    stackHint: 'Node + node-cron + Docker + Evolution WA',
    wiredNote: 'unlinked — roda em Docker próprio',
