...
const LABELS = {
  ...
  socialhub_post_acao: 'mexer no post do TeusHub',
  teushub_ney_filmes: 'postar os vídeos da pasta no Ney Filmes',
  minerador_em_alta: 'ver o que está bombando no Kwai',
  minerador_paginas: 'ver as páginas vigiadas',
  minerador_pagina: 'mexer nas páginas vigiadas do Minerador',
  minerador_video: 'marcar o vídeo no Minerador',
  minerador_varrer: 'varrer a página inteira no Kwai',
