...
- PROIBIDO no hero: monorepo, Docker, Postgres, Redis, FFmpeg, Groq, pnpm, health, API, worker
- Traduza o brief técnico em benefício
- 4–5 seções com body concreto (não placeholders)
- CTAs em português`,
        user:
          `Produto id: ${projectId}\n` +
          `Nome comercial: ${briefCtx.name}\n` +
          `Brief interno (traduza pra marketing): ${briefCtx.brief}\n` +
          `Pitch sugerido: ${customerPitch(briefCtx.brief, briefCtx.name, projectId)}\n` +
