...
const CREST_BY_ALIAS = {
  ...
  flamengo: { file: 'Clube_de_Regatas_do_Flamengo_logo.svg', name: 'Flamengo' },
  mengão: { file: 'Clube_de_Regatas_do_Flamengo_logo.svg', name: 'Flamengo' },
  mengao: { file: 'Clube_de_Regatas_do_Flamengo_logo.svg', name: 'Flamengo' },
  crf: { file: 'Clube_de_Regatas_do_Flamengo_logo.svg', name: 'Flamengo' },
