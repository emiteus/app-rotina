...
const TOOL_DEFS = {
  ...
  pc_close_tab: {
    ...
    ownerOnly: true,
    description:
      'Fecha UMA aba do navegador do PC pelo nome ("fecha a aba do YouTube" → aba = YouTube). Passa pelas abas até achar a que tem esse texto no título. Args: aba (texto do título, curto).'
  },
  pc_screen_look: {
    risk: 'medium',
    timeoutMs: 60000,
