...
/** Categorias do TeusHub com as contas de cada uma. */
async function listarCategorias() {
  return shFetch('/api/ops/categories');
}

/** Autorização de upload direto PC → Cloudinary (vale 1 h, só vídeo, pasta fixa). */
async function assinarUpload() {
  return shFetch('/api/ops/media/sign', { method: 'POST', body: '{}', timeoutMs: 15000 });
}
